...
def train(args):
    ...
    model = models.AraT5RevDict(args).to(args.device)
    ...
    for epoch in tqdm.trange(EPOCHS, desc="Epochs"):
        ...
        for ids, word, gloss, electra, sgns in train_dataloader:
            ...
            mse_loss = criterion(pred_embs, target_embs)
...
def pred(args):
    ...
    model = models.AraT5RevDict(args).load(f"{args.save_dir}/model_best.pt")
